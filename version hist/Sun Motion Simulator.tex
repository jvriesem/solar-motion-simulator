...
\else
	...
	% Copyright label
	\draw[decoration={text along path,
	      text={|\normalsize| Copyright 2021 by Jess W. Vriesema},text align={center},text color=black,raise=0.0cm},decorate] (180:\SolarFrameCopyrightLabelRadius) arc[start angle=180,end angle=270,radius=\SolarFrameCopyrightLabelRadius];
...
\node[font=\normalsize, text width=\HelpCardWidth/\HelpDiskTextScale-2*\HelpDiskTextMargin/\HelpDiskTextScale, scale=\HelpDiskTextScale] at (0,0) {
		\centering
		\textbf{\copyright 2021 by Jess W. Vriesema. All rights reserved.} \\
		 Email: \href{mailto:Jess.Vriesema@gmail.com}{Jess.Vriesema@gmail.com} \\
		 Web page: \url{https://www.lpl.arizona.edu/~vriesema/} \\
		 \bigskip
		 This original work is licensed under the Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License. To view a copy of this license, visit
...
% Copyright label
\draw[decoration={text along path,
      text={|\footnotesize| Copyright 2021 by Jess W. Vriesema},text align={center},text color=black,raise=0.0cm},decorate] (270:\SolarFrameCopyrightLabelRadius) arc[start angle=270,end angle=180,radius=\SolarFrameCopyrightLabelRadius];
