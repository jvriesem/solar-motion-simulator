...
\hypersetup{
    ...
    pdfauthor={Jess Vriesema},     % author
    pdfsubject={Solar Motion Simulator},   % subject of the document
    pdfcreator={Jess Vriesema},   % creator of the document
    pdfproducer={Jess Vriesema}, % producer of the document
...
\newcommand*{\SunCarriageXShift}{-3cm}
\newcommand*{\SunCarriageYShift}{5.625cm}
...
\newcommand*{\SolarFrameCenterSupportFlapLength}{2cm} % both right and left of (0,0)
\newcommand*{\SolarFrameCenterSupportFlapWidth}{1cm}
...
%	\draw[style=LaserCutterOutlineCut,color=black, line width=\LaserCutterLineWidth] 
...
%		\draw[style=LaserCutterFoldAid,color=\LaserCutterColor,line width=\LaserCutterLineWidth] (0,-\SolarFrameOuterRadius-\SolarFrameFootHeight) -- (-\SolarFrameFootLength,-\SolarFrameOuterRadius-\SolarFrameFootHeight);
		...
		\draw[style=LaserCutterCut,color=\LaserCutterColor,line width=\LaserCutterLineWidth] (0,\SolarFrameCenterSupportFlapWidth-\LaserCutFoldWidth) -- (0,\SolarFrameCenterSupportFlapWidth);
...
\else
	...
	\draw[\valleyFold,line width=1pt] (0,0) -- (0,\SolarFrameCenterSupportFlapWidth);
	...
	% Copyright label
	\draw[decoration={text along path,
	      text={|\normalsize| Copyright 2021 by Jess Vriesema},text align={center},text color=black,raise=0.0cm},decorate] (180:\SolarFrameCopyrightLabelRadius) arc[start angle=180,end angle=270,radius=\SolarFrameCopyrightLabelRadius];
...
\node[font=\normalsize, text width=\HelpCardWidth/\HelpDiskTextScale-2*\HelpDiskTextMargin/\HelpDiskTextScale, scale=\HelpDiskTextScale] at (0,0) {
		\centering
		\textbf{\copyright 2021 by Jess Vriesema. All rights reserved.} \\
		 Email: \href{mailto:Jess.Vriesema@gmail.com}{Jess.Vriesema@gmail.com} \\
...
\url{http://creativecommons.org/licenses/by-nc-sa/4.0/}. \\
		\bigskip
		TODO: \\
		For more information, please visit \url{https://www.exampleA.com}. \\
		A video of the assembly instructions is available at \url{https://www.exampleB.com}.
	};
	\draw[line width=\HelpCardBorderWidth,color=\OutlineColor] (-\HelpCardWidth/2,-\HelpCardHeight/2) rectangle (\HelpCardWidth/2,\HelpCardHeight/2);
...
%	      text={|\large|Solar Arm},text align={center},text color=black,raise=0.0cm},decorate] (90:0.4*\SolarFrameOuterRadius+0.6*\SolarFrameInnerRadius) arc[start angle=90,end angle=\axialTilt,radius=0.4*\SolarFrameOuterRadius+0.6*\SolarFrameInnerRadius];
	...
	\draw[decoration={text along path,
	      text={|\footnotesize|19-21 Mar.},text align={left},text color=black,raise=0.2cm},decorate] (-43:0.4*\SolarFrameOuterRadius+0.6*\SolarFrameInnerRadius) arc[start angle=-43,end angle=-58,radius=0.4*\SolarFrameOuterRadius+0.6*\SolarFrameInnerRadius];
	\draw[decoration={text along path,
	      text={|\footnotesize|20-21 Jun.},text align={left},text color=black,raise=-0.1cm},decorate] (-43:0.4*\SolarFrameOuterRadius+0.6*\SolarFrameInnerRadius) arc[start angle=-43,end angle=-58,radius=0.4*\SolarFrameOuterRadius+0.6*\SolarFrameInnerRadius];
	\draw[decoration={text along path,
	      text={|\footnotesize|21-24 Sep.},text align={left},text color=black,raise=-0.4cm},decorate] (-43:0.4*\SolarFrameOuterRadius+0.6*\SolarFrameInnerRadius) arc[start angle=-43,end angle=-58,radius=0.4*\SolarFrameOuterRadius+0.6*\SolarFrameInnerRadius];
	\draw[decoration={text along path,
	      text={|\footnotesize|20-22 Dec.},text align={left},text color=black,raise=-0.7cm},decorate] (-43:0.4*\SolarFrameOuterRadius+0.6*\SolarFrameInnerRadius) arc[start angle=-43,end angle=-58,radius=0.4*\SolarFrameOuterRadius+0.6*\SolarFrameInnerRadius];
...
\draw[\mountainFold,line width=1pt] (0,0) -- (0,\SolarFrameCenterSupportFlapWidth);
\draw[\mountainFold,line width=1pt] (0,-\SolarFrameOuterRadius-\SolarFrameFootHeight) -- (\SolarFrameFootLength,-\SolarFrameOuterRadius-\SolarFrameFootHeight);
\draw[\valleyFold,line width=1pt] (0,-\SolarFrameOuterRadius-\SolarFrameFootHeight) -- (-\SolarFrameFootLength,-\SolarFrameOuterRadius-\SolarFrameFootHeight);
%\SolarFrameExtraFootHeight
...
% Copyright label
\draw[decoration={text along path,
      text={|\footnotesize| Copyright 2021 by Jess Vriesema},text align={center},text color=black,raise=0.0cm},decorate] (270:\SolarFrameCopyrightLabelRadius) arc[start angle=270,end angle=180,radius=\SolarFrameCopyrightLabelRadius];
