...
\PrintInstructionsfalse  % set \PrintInstructions to true
...
%	\node[scale=\SolarFrameLatitudeMajorLineLabelScale,font=\normalsize,rotate=-90] at (-90:\SolarFrameCenterLatitudeArcRadius-\SolarFrameLatitudeMajorLineLength-\SolarFrameLatitudeMajorLineLabelOffset) {$0^\circ$}; %{Equator};
	...
	% Copyright label
	\draw[decoration={text along path,
	      text={|\footnotesize| Copyright 2023 by Jess W. Vriesema of UWEC},text align={center},text color=black,raise=0.0cm},decorate] (180:\SolarFrameCopyrightLabelRadius) arc[start angle=180,end angle=250,radius=\SolarFrameCopyrightLabelRadius];
...
\url{http://creativecommons.org/licenses/by-nc-sa/4.0/}.} \\
		\bigskip
		\textbf{\copyright 2023 by Jess W. Vriesema \\of the University of Wisconsin--Eau Claire} \\
		\bigskip
...
% Copyright label
\draw[decoration={text along path,
      text={|\footnotesize| Copyright 2023 by Jess~W.~Vriesema of UWEC},text align={center},text color=black,raise=0.0cm},decorate] (250:\SolarFrameCopyrightLabelRadius) arc[start angle=250,end angle=180,radius=\SolarFrameCopyrightLabelRadius];
...
\vfill
\hrule 
\noindent\copyright 2023 by \href{https://www.lpl.arizona.edu/~vriesema/}{Jess W. Vriesema} of the University of Wisconsin--Eau Claire. All rights reserved. 
	\end{multicols}
