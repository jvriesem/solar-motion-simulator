...
\PrintHelperLinesfalse  % set \printHelperLines to false
...
\begin{scope}[xshift=\CreditsMsgXShift,yshift=\CreditsMsgYShift,rotate=\CreditsMsgRotation]
	\ifLaserCutterMode
		 ...
		 %\relax
	\else
		\node[font=\large, text width=\HelpCardWidth/\HelpDiskTextScale-2*\HelpDiskTextMargin/\HelpDiskTextScale, scale=\HelpDiskTextScale] at (0.25,0.45) {
			This papercraft model was developed by \\
			\href{https://calvin.edu/people/jess-vriesema}{Jess W. Vriesema} (Calvin University) \\
			with numerous suggestions from \\
			\href{https://www.uwec.edu/profiles/howardta}{Turner Howard} (University of\\
			 Wisconsin--Eau Claire). It was inspired by \\
			 the Solar Motion Demonstrator, which \\
			 was created by Joseph L. Snider \\
			 (Oberlin College, ret.).
		};
%		\node[font=\large, text width=\HelpCardWidth/\HelpDiskTextScale-2*\HelpDiskTextMargin/\HelpDiskTextScale, scale=\HelpDiskTextScale] at (0,-0.65) {
...
\ifPrintWishlist
	...
	\begin{itemize}
		...
		\item Add an arrow on the Time Dial to show the direction of time? (Kinda unnecessary....)
		...
		\item Revise the instruction card and instructions to use less jargon. 
