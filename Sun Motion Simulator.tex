...
\newcommand*{\TimeDiskSixHourLabelOffset}{0.15cm}
...
\newcommand*{\TimeDiskOneHourTickSize}{0.3cm}
\newcommand*{\TimeDiskOneHourTickWidth}{0.03cm}
\newcommand*{\TimeDiskOneHourLabelOffset}{0.1cm}
...
%\newcommand*{\TimeDiskHalfHourLabelOffset}{0.2cm}
%\newcommand*{\TimeDiskHalfHourLabelScale}{0.75}
...
%	\node[scale=\TimeDiskSixHourLabelScale,font=\normalsize] at (180:\TimeDiskRadius-\TimeDiskSixHourTickSize-2*\TimeDiskSixHourLabelOffset) {18};
	...
	\foreach \x in {1,...,359} 
	{
		...
		\ifnum0=\pgfmathresult\relax
			...
			\node[scale=\TimeDiskSixHourLabelScale,font=\normalsize] at (90-\x:\TimeDiskRadius-\TimeDiskSixHourTickSize-2*\TimeDiskSixHourLabelOffset) {\hour};
		\else
			...
			\ifnum0=\pgfmathresult\relax
				...
				\pgfmathsetmacro{\hour}{int(\x/15)}
				\draw[line width=\TimeDiskOneHourTickWidth] (90-\x:\TimeDiskRadius) --  (90-\x:\TimeDiskRadius-\TimeDiskOneHourTickSize);
				\node[scale=\TimeDiskOneHourLabelScale,font=\normalsize,rotate=0] at (90-\x:\TimeDiskRadius-\TimeDiskOneHourTickSize-2*\TimeDiskOneHourLabelOffset) {\hour};
			\else
				% Is it a half hour?
